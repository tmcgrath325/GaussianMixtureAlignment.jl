function gogma_align(gmmx::AbstractGMM, gmmy::AbstractGMM; interactions=nothing, lohifun=lohi_interval, kwargs...)
    pσ, pϕ = pairwise_consts(gmmx,gmmy,interactions)
    boundsfun(x,y,block) = gauss_l2_bounds(x,y,block,pσ,pϕ;lohifun=lohifun)
    localfun(x,y,block) = local_align(x,y,block,pσ,pϕ)
    return branchbound(gmmx, gmmy; boundsfun=boundsfun, localfun=localfun, kwargs...)
end
function rot_gogma_align(gmmx::AbstractGMM, gmmy::AbstractGMM; interactions=nothing, lohifun=lohi_interval, kwargs...)
    pσ, pϕ = pairwise_consts(gmmx,gmmy,interactions)
    boundsfun(x,y,block) = gauss_l2_bounds(x,y,block,pσ,pϕ;lohifun=lohifun)
    localfun(x,y,block) = local_align(x,y,block,pσ,pϕ)
    rot_branchbound(gmmx, gmmy; boundsfun=boundsfun, localfun=localfun, kwargs...)
end
function trl_gogma_align(gmmx::AbstractGMM, gmmy::AbstractGMM; interactions=nothing, lohifun=lohi_interval, kwargs...) 
    pσ, pϕ = pairwise_consts(gmmx,gmmy,interactions)
    boundsfun(x,y,block) = gauss_l2_bounds(x,y,block,pσ,pϕ;lohifun=lohifun)
    localfun(x,y,block) = local_align(x,y,block,pσ,pϕ)
    trl_branchbound(gmmx, gmmy; boundsfun=boundsfun, localfun=localfun, kwargs...)
end
function tiv_gogma_align(gmmx::AbstractGMM, gmmy::AbstractGMM, cx=Inf, cy=Inf; lohifun=lohi_interval, kwargs...)
    tivgmmx, tivgmmy = tivgmm(gmmx, cx), tivgmm(gmmy, cy)
    pσ, pϕ = pairwise_consts(gmmx,gmmy)
    tivpσ, tivpϕ = pairwise_consts(tivgmmx,tivgmmy)
    boundsfun(x,y,block) = gauss_l2_bounds(x,y,block,pσ,pϕ;lohifun=lohifun)
    rot_boundsfun(x,y,block) = gauss_l2_bounds(x,y,block,tivpσ,tivpϕ;lohifun=lohifun)
    localfun(x,y,block) = local_align(x,y,block,pσ,pϕ)
